...
// Generated Mon Jun 3 15:29:10 2024
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._dropdown_cloner_uk.callChildLogicBlocks_mouseover = function(){
			if(me._dropdown_cloner_uk.ggInstances) {
				...
				for(i = 0; i < me._dropdown_cloner_uk.ggInstances.length; i++) {
					...
					if (me._dropdown_cloner_uk.ggInstances[i]._home_uk && me._dropdown_cloner_uk.ggInstances[i]._home_uk.logicBlock_textcolor) {
						me._dropdown_cloner_uk.ggInstances[i]._home_uk.logicBlock_textcolor();
					}
				}
			}
		}
		...
		me._dropdown_cloner_icho.callChildLogicBlocks_mouseover = function(){
			if(me._dropdown_cloner_icho.ggInstances) {
				...
				for(i = 0; i < me._dropdown_cloner_icho.ggInstances.length; i++) {
					...
					if (me._dropdown_cloner_icho.ggInstances[i]._home_icho && me._dropdown_cloner_icho.ggInstances[i]._home_icho.logicBlock_textcolor) {
						me._dropdown_cloner_icho.ggInstances[i]._home_icho.logicBlock_textcolor();
					}
				}
			}
		}
		...
		me._dropdown_cloner_mark.callChildLogicBlocks_mouseover = function(){
			if(me._dropdown_cloner_mark.ggInstances) {
				...
				for(i = 0; i < me._dropdown_cloner_mark.ggInstances.length; i++) {
					...
					if (me._dropdown_cloner_mark.ggInstances[i]._home_mark && me._dropdown_cloner_mark.ggInstances[i]._home_mark.logicBlock_textcolor) {
						me._dropdown_cloner_mark.ggInstances[i]._home_mark.logicBlock_textcolor();
					}
				}
			}
		}
		...
		me._dropdown_cloner_ya.callChildLogicBlocks_mouseover = function(){
			if(me._dropdown_cloner_ya.ggInstances) {
				...
				for(i = 0; i < me._dropdown_cloner_ya.ggInstances.length; i++) {
					...
					if (me._dropdown_cloner_ya.ggInstances[i]._home_ya && me._dropdown_cloner_ya.ggInstances[i]._home_ya.logicBlock_textcolor) {
						me._dropdown_cloner_ya.ggInstances[i]._home_ya.logicBlock_textcolor();
					}
				}
			}
		}
		...
		el=me._lowtitle=document.createElement('div');
		els=me._lowtitle__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="LowTitle";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._lowtitle.ggUpdateText=function() {
		...
		me._lowtitle.ggUpdateText();
		el.appendChild(els);
		me._lowtitle.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._lowtitle.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				(player.getViewerSize().width <= 1200) || 
				(player.getViewerSize().height <= 800)
			...
			if (me._lowtitle.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._lowtitle.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._lowtitle.style[domTransition]='left 0s, bottom 0s, ' + cssPrefix + 'transform 0s';
				if (me._lowtitle.ggCurrentLogicStatePosition == 0) {
					me._lowtitle.style.left='114px';
					me._lowtitle.style.bottom='75px';
				}
				else {
					me._lowtitle.style.left='134px';
					me._lowtitle.style.bottom='65px';
				}
			}
		}
		me._lowtitle.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getViewerSize().width <= 1200) || 
				(player.getViewerSize().height <= 800)
			...
			if (me._lowtitle.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._lowtitle.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._lowtitle.style[domTransition]='left 0s, bottom 0s, ' + cssPrefix + 'transform 0s';
				if (me._lowtitle.ggCurrentLogicStateScaling == 0) {
					me._lowtitle.ggParameter.sx = 0.8;
					me._lowtitle.ggParameter.sy = 0.8;
					me._lowtitle.style[domTransform]=parameterToTransform(me._lowtitle.ggParameter);
				}
				else {
					me._lowtitle.ggParameter.sx = 1;
					me._lowtitle.ggParameter.sy = 1;
					me._lowtitle.style[domTransform]=parameterToTransform(me._lowtitle.ggParameter);
				}
			}
		}
		me._lowtitle.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._lowtitle);
		...
		me._toggle2.onclick=function (e) {
			me._lowtitle.ggVisible = !me._lowtitle.ggVisible;
			var flag=me._lowtitle.ggVisible;
			me._lowtitle.style[domTransition]='none';
			me._lowtitle.style.visibility=((flag)&&(Number(me._lowtitle.style.opacity)>0||!me._lowtitle.style.opacity))?'inherit':'hidden';
		...
		me._popup_image.ggUpdatePosition=function (useTransition) {
			...
			me._popup_image__img.setAttribute('style','position: absolute; left: 50%; margin-left: -' + currentWidth/2 + 'px; top: 50%; margin-top: -' + currentHeight/2 + 'px;height:' + parentHeight + 'px;-webkit-user-drag:none;pointer-events:none;border-radius:16px;;');
			} else {
			currentWidth = parentWidth;
			currentHeight = parentWidth / aspectRatioImg;
			me._popup_image__img.setAttribute('style','position: absolute; left: 50%; margin-left: -' + currentWidth/2 + 'px; top: 50%; margin-top: -' + currentHeight/2 + 'px;width:' + parentWidth + 'px;-webkit-user-drag:none;pointer-events:none;border-radius:16px;;');
			};
		}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'MSA4IDE3LjA4NTg3MjYgMTcuMDg1ODcyNiAxNy4wODU4NzI2IDE3LjA4NTg3MjYgOCAyMi45MTQxMjc0IDggMjIuOTE0MTI3NCAxNy4wODU4NzI2IDMyIDE3LjA4NTg3MjYgMzIgMjIuODY5ODA2MSI+PC9wb2x5Z29uPgogICAgICAgICAgICA8L2c+CiAgICAgICAgPC9nPgogICAgPC9nPgo8L3N2Zz4=';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'';
		...
		me._container_cards.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getViewerSize().width <= 1200) || 
				(player.getViewerSize().height <= 800)
			...
			if (me._container_cards.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._container_cards.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._container_cards.style[domTransition]='' + cssPrefix + 'transform 500ms ease 0ms';
				if (me._container_cards.ggCurrentLogicStateScaling == 0) {
					me._container_cards.ggParameter.sx = 0.6;
					me._container_cards.ggParameter.sy = 0.6;
					me._container_cards.style[domTransform]=parameterToTransform(me._container_cards.ggParameter);
				}
				else if (me._container_cards.ggCurrentLogicStateScaling == 1) {
					me._container_cards.ggParameter.sx = 0.4;
					me._container_cards.ggParameter.sy = 0.4;
					me._container_cards.style[domTransform]=parameterToTransform(me._container_cards.ggParameter);
				}
				else {
					me._container_cards.ggParameter.sx = 1;
					me._container_cards.ggParameter.sy = 1;
					me._container_cards.style[domTransform]=parameterToTransform(me._container_cards.ggParameter);
				}
			}
		}
		...
		me._container_cards.appendChild(me._image_1);
		...
		me._container_cards.appendChild(me._image_2);
		...
		me._container_cards.appendChild(me._image_3);
		...
		me._container_cards.appendChild(me._image_4);
		el=me._mapbtn=document.createElement('div');
		els=me._mapbtn__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		me._mapbtn__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;mapbtn;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="map-btn";
		...
		me._mapbtn.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
			...
			if (me._mapbtn.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._mapbtn.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._mapbtn.style[domTransition]='opacity 0s, visibility 0s';
				if (me._mapbtn.ggCurrentLogicStateAlpha == 0) {
					me._mapbtn.style.visibility=me._mapbtn.ggVisible?'inherit':'hidden';
					me._mapbtn.style.opacity=1;
				}
				else {
					me._mapbtn.style.visibility=me._mapbtn.ggVisible?'inherit':'hidden';
					me._mapbtn.style.opacity=0.79999;
				}
			}
		}
		...
		me._mapbtn.onmouseover=function (e) {
			me.elementMouseOver['mapbtn']=true;
			me._mapbtn.logicBlock_alpha();
		}
		me._mapbtn.onmouseout=function (e) {
			me.elementMouseOver['mapbtn']=false;
			me._mapbtn.logicBlock_alpha();
		}
		me._mapbtn.ontouchend=function (e) {
			me.elementMouseOver['mapbtn']=false;
			me._mapbtn.logicBlock_alpha();
		}
		me._mapbtn.ggUpdatePosition=function (useTransition) {
		}
		me._container_cards.appendChild(me._mapbtn);
		...
		me._container_cards.appendChild(me._coverlogo);
		me._cover.appendChild(me._container_cards);
		el=me._container_maps=document.createElement('div');
		el.ggId="Container maps";
		el.ggDx=12;
		el.ggDy=56;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		me._container_maps.logicBlock_scaling = function() {
			var newLogicStateScaling;
			if (
				(player.getViewerSize().width <= 1200) || 
				(player.getViewerSize().height <= 800)
			...
			if (me._container_maps.ggCurrentLogicStateScaling != newLogicStateScaling) {
				me._container_maps.ggCurrentLogicStateScaling = newLogicStateScaling;
				me._container_maps.style[domTransition]='' + cssPrefix + 'transform 0s';
				if (me._container_maps.ggCurrentLogicStateScaling == 0) {
					me._container_maps.ggParameter.sx = 0.6;
					me._container_maps.ggParameter.sy = 0.6;
					me._container_maps.style[domTransform]=parameterToTransform(me._container_maps.ggParameter);
				}
				else if (me._container_maps.ggCurrentLogicStateScaling == 1) {
					me._container_maps.ggParameter.sx = 0.4;
					me._container_maps.ggParameter.sy = 0.4;
					me._container_maps.style[domTransform]=parameterToTransform(me._container_maps.ggParameter);
				}
				else {
					me._container_maps.ggParameter.sx = 1;
					me._container_maps.ggParameter.sy = 1;
					me._container_maps.style[domTransform]=parameterToTransform(me._container_maps.ggParameter);
				}
			}
		}
		me._container_maps.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		el=me._bigmap=document.createElement('div');
		els=me._bigmap__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		me._bigmap__img.setAttribute('src',basePath + 'images/bigmap.svg');
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;bigmap;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="bigmap";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._bigmap.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._bigmap.ggUpdatePosition=function (useTransition) {
		}
		me._container_maps.appendChild(me._bigmap);
		el=me._cardbtn=document.createElement('div');
		els=me._cardbtn__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'ICA8L2c+Cjwvc3ZnPg==';
		me._cardbtn__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;cardbtn;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="card-btn";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._cardbtn.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._cardbtn.logicBlock_alpha = function() {
			var newLogicStateAlpha;
			if (
			...
			if (me._cardbtn.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				me._cardbtn.ggCurrentLogicStateAlpha = newLogicStateAlpha;
				me._cardbtn.style[domTransition]='opacity 0s, visibility 0s';
				if (me._cardbtn.ggCurrentLogicStateAlpha == 0) {
					me._cardbtn.style.visibility=me._cardbtn.ggVisible?'inherit':'hidden';
					me._cardbtn.style.opacity=1;
				}
				else {
					me._cardbtn.style.visibility=me._cardbtn.ggVisible?'inherit':'hidden';
					me._cardbtn.style.opacity=0.79999;
				}
			}
		}
		...
		me._cardbtn.onmouseover=function (e) {
			me.elementMouseOver['cardbtn']=true;
			me._cardbtn.logicBlock_alpha();
		}
		me._cardbtn.onmouseout=function (e) {
			me.elementMouseOver['cardbtn']=false;
			me._cardbtn.logicBlock_alpha();
		}
		me._cardbtn.ontouchend=function (e) {
			me.elementMouseOver['cardbtn']=false;
			me._cardbtn.logicBlock_alpha();
		}
		me._cardbtn.ggUpdatePosition=function (useTransition) {
		}
		me._container_maps.appendChild(me._cardbtn);
		el=me._yara=document.createElement('div');
		el.ggId="yara";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		me._yara.onclick=function (e) {
			player.setVariableValue('currentPan', "1");
			player.setVariableValue('coverShow', false);
			player.openNext("{node1}","");
		}
		me._yara.ggUpdatePosition=function (useTransition) {
		}
		me._container_maps.appendChild(me._yara);
		...
		me._container_maps.appendChild(me._mark);
		el=me._icho=document.createElement('div');
		el.ggId="icho";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		me._icho.onclick=function (e) {
			player.setVariableValue('currentPan', "3");
			player.setVariableValue('coverShow', false);
			player.openNext("{node43}","");
		}
		me._icho.ggUpdatePosition=function (useTransition) {
		}
		me._container_maps.appendChild(me._icho);
		el=me._uk=document.createElement('div');
		el.ggId="uk";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		me._uk.onclick=function (e) {
			player.setVariableValue('currentPan', "4");
			player.setVariableValue('coverShow', false);
			player.openNext("{node63}","");
		}
		me._uk.ggUpdatePosition=function (useTransition) {
		}
		me._container_maps.appendChild(me._uk);
		el=me._coverlogo1=document.createElement('div');
		els=me._coverlogo1__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		me._coverlogo1__img.setAttribute('src',basePath + 'images/coverlogo1.svg');
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;coverlogo1;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		el.ggId="cover-logo-1";
		el.ggDx=0;
		el.ggDy=-400;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._coverlogo1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._coverlogo1.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._container_maps.appendChild(me._coverlogo1);
		me._cover.appendChild(me._container_maps);
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		me._tt_ht_image.logicBlock_position = function() {
			...
			if (me._tt_ht_image.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_ht_image.style[domTransition]='left 0s, bottom 0s';
				if (me._tt_ht_image.ggCurrentLogicStatePosition == 0) {
					this.ggDx = -50;
					me._tt_ht_image.style.bottom='-47px';
					me._tt_ht_image.ggUpdatePosition(true);
				}
				else {
					me._tt_ht_image.ggDx=2;
					me._tt_ht_image.style.bottom='48px';
					me._tt_ht_image.ggUpdatePosition(true);
				}
			}
		}
	...
	function SkinCloner_dropdown_cloner_uk_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._itembg_uk.onmouseover=function (e) {
			...
			me._home_uk.logicBlock_textcolor();
		...
		el=me._home_uk=document.createElement('div');
		els=me._home_uk__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="home uk";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.appendChild(els);
		me._home_uk.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._home_uk.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				(me.elementMouseOver['itembg_uk'] == true)
			)
			...
			if (me._home_uk.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me._home_uk.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me._home_uk__text.style[domTransition]='color 0s';
				if (me._home_uk.ggCurrentLogicStateTextColor == 0) {
					me._home_uk__text.style.color="rgba(255,255,255,1)";
				}
				else if (me._home_uk.ggCurrentLogicStateTextColor == 1) {
					me._home_uk__text.style.color="rgba(43,94,74,1)";
				}
				else {
					me._home_uk__text.style.color="rgba(255,255,255,1)";
				}
		...
		me._home_uk.onclick=function (e) {
			if (
				(
					(me._home_uk.ggIsActive() == false)
				)
			) {
				player.openNext("{"+me.ggNodeId+"}",player.hotspot.target);
			}
		}
		me._home_uk.ggUpdatePosition=function (useTransition) {
		}
		me._itembg_uk.appendChild(me._home_uk);
	...
	function SkinCloner_dropdown_cloner_icho_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._itembg_icho.onmouseover=function (e) {
			...
			me._home_icho.logicBlock_textcolor();
		...
		el=me._home_icho=document.createElement('div');
		els=me._home_icho__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="home icho";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		els.innerHTML=me.ggUserdata.information;
		el.appendChild(els);
		me._home_icho.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._home_icho.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				(me.elementMouseOver['itembg_icho'] == true)
			)
			...
			if (me._home_icho.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me._home_icho.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me._home_icho__text.style[domTransition]='color 0s';
				if (me._home_icho.ggCurrentLogicStateTextColor == 0) {
					me._home_icho__text.style.color="rgba(255,255,255,1)";
				}
				else if (me._home_icho.ggCurrentLogicStateTextColor == 1) {
					me._home_icho__text.style.color="rgba(43,94,74,1)";
				}
				else {
					me._home_icho__text.style.color="rgba(255,255,255,1)";
				}
		...
		me._home_icho.onclick=function (e) {
			if (
				(
					(me._home_icho.ggIsActive() == false)
				)
			) {
				player.openNext("{"+me.ggNodeId+"}",player.hotspot.target);
			}
		}
		me._home_icho.ggUpdatePosition=function (useTransition) {
		}
		me._itembg_icho.appendChild(me._home_icho);
	...
	function SkinCloner_dropdown_cloner_mark_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._itembg_mark.onmouseover=function (e) {
			...
			me._home_mark.logicBlock_textcolor();
		...
		el=me._home_mark=document.createElement('div');
		els=me._home_mark__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="home mark";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		els.innerHTML=me.ggUserdata.information;
		el.appendChild(els);
		me._home_mark.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._home_mark.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				(me.elementMouseOver['itembg_mark'] == true)
			)
			...
			if (me._home_mark.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me._home_mark.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me._home_mark__text.style[domTransition]='color 0s';
				if (me._home_mark.ggCurrentLogicStateTextColor == 0) {
					me._home_mark__text.style.color="rgba(255,255,255,1)";
				}
				else if (me._home_mark.ggCurrentLogicStateTextColor == 1) {
					me._home_mark__text.style.color="rgba(43,94,74,1)";
				}
				else {
					me._home_mark__text.style.color="rgba(255,255,255,1)";
				}
		...
		me._home_mark.onclick=function (e) {
			if (
				(
					(me._home_mark.ggIsActive() == false)
				)
			) {
				player.openNext("{"+me.ggNodeId+"}",player.hotspot.target);
			}
		}
		me._home_mark.ggUpdatePosition=function (useTransition) {
		}
		me._itembg_mark.appendChild(me._home_mark);
	...
	function SkinCloner_dropdown_cloner_ya_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me._itembg_ya.onmouseover=function (e) {
			...
			me._home_ya.logicBlock_textcolor();
		...
		el=me._home_ya=document.createElement('div');
		els=me._home_ya__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="home ya";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		els.innerHTML=me.ggUserdata.information;
		el.appendChild(els);
		me._home_ya.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._home_ya.logicBlock_textcolor = function() {
			var newLogicStateTextColor;
			if (
				(me.elementMouseOver['itembg_ya'] == true)
			)
			...
			if (me._home_ya.ggCurrentLogicStateTextColor != newLogicStateTextColor) {
				me._home_ya.ggCurrentLogicStateTextColor = newLogicStateTextColor;
				me._home_ya__text.style[domTransition]='color 0s';
				if (me._home_ya.ggCurrentLogicStateTextColor == 0) {
					me._home_ya__text.style.color="rgba(255,255,255,1)";
				}
				else if (me._home_ya.ggCurrentLogicStateTextColor == 1) {
					me._home_ya__text.style.color="rgba(43,94,74,1)";
				}
				else {
					me._home_ya__text.style.color="rgba(255,255,255,1)";
				}
		...
		me._home_ya.onclick=function (e) {
			if (
				(
					(me._home_ya.ggIsActive() == false)
				)
			) {
				player.openNext("{"+me.ggNodeId+"}",player.hotspot.target);
			}
		}
		me._home_ya.ggUpdatePosition=function (useTransition) {
		}
		me._itembg_ya.appendChild(me._home_ya);
	...
	me._lowtitle.logicBlock_position();
	me._lowtitle.logicBlock_scaling();
	me._toggle2.logicBlock_position();
	me._toggle2.logicBlock_scaling();
	me._abouttext.logicBlock_scaling();
	me._help.logicBlock_scaling();
	me._container_cards.logicBlock_scaling();
	me._container_maps.logicBlock_scaling();
	...
	player.addListener('sizechanged', function(args) { me._map_bg.logicBlock_scaling();me._main_menu.logicBlock_position();me._main_menu.logicBlock_scaling();me._lowtitle.logicBlock_position();me._lowtitle.logicBlock_scaling();me._toggle2.logicBlock_position();me._toggle2.logicBlock_scaling();me._abouttext.logicBlock_scaling();me._help.logicBlock_scaling();me._container_cards.logicBlock_scaling();me._container_maps.logicBlock_scaling(); });
	player.addListener('changenodeid', function(args) { me._scrollarea_uk.logicBlock_visible();me._scrollarea_icho.logicBlock_visible();me._scrollarea_mark.logicBlock_visible();me._scrollarea_ya.logicBlock_visible();me._abouttext.logicBlock_visible();me._screentint_image.logicBlock_visible();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._image_popup_close.logicBlock_visible();me._help.logicBlock_visible();me._cover.logicBlock_visible(); });
	...
	player.addListener('mouseover', function(args) { me.callChildLogicBlocksHotspot_airpin_mouseover();me.callChildLogicBlocksHotspot_redpin_mouseover();me.callChildLogicBlocksHotspot_ht_image_mouseover(); });
