...
// Generated Wed Sep 28 12:25:54 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._green_waves__img.setAttribute('src',basePath + 'embed/images/green_waves.svg');
		...
		this._map_button__img.setAttribute('src',basePath + 'embed/images/map_button.svg');
		...
		this._map_button__imgo.setAttribute('src',basePath + 'embed/images/map_button__o.svg');
		...
		this._fullscreen__img.setAttribute('src',basePath + 'embed/images/fullscreen.svg');
		...
		this._fullscreen__imgo.setAttribute('src',basePath + 'embed/images/fullscreen__o.svg');
		...
		this._gyro__img.setAttribute('src',basePath + 'embed/images/gyro.svg');
		...
		this._gyro__imgo.setAttribute('src',basePath + 'embed/images/gyro__o.svg');
		...
		this._rotate__img.setAttribute('src',basePath + 'embed/images/rotate.svg');
		...
		this._rotate__imgo.setAttribute('src',basePath + 'embed/images/rotate__o.svg');
		...
		this._sound__img.setAttribute('src',basePath + 'embed/images/sound.svg');
		...
		this._sound__imgo.setAttribute('src',basePath + 'embed/images/sound__o.svg');
		...
		this._home__img.setAttribute('src',basePath + 'embed/images/home.svg');
		...
		this._home__imgo.setAttribute('src',basePath + 'embed/images/home__o.svg');
		...
		this._zoom_out__img.setAttribute('src',basePath + 'embed/images/zoom_out.svg');
		...
		this._zoom_out__imgo.setAttribute('src',basePath + 'embed/images/zoom_out__o.svg');
		...
		this._zoom_in__img.setAttribute('src',basePath + 'embed/images/zoom_in.svg');
		...
		this._zoom_in__imgo.setAttribute('src',basePath + 'embed/images/zoom_in__o.svg');
		...
		this._toggle2__img.setAttribute('src',basePath + 'embed/images/toggle2.svg');
		...
		this._toggle2__imgo.setAttribute('src',basePath + 'embed/images/toggle2__o.svg');
		...
		this._green_circle__img.setAttribute('src',basePath + 'embed/images/green_circle.svg');
		...
		this._arrow_up__img.setAttribute('src',basePath + 'embed/images/arrow_up.svg');
		...
		this._arrow_up__imgo.setAttribute('src',basePath + 'embed/images/arrow_up__o.svg');
		...
		this._arrow_right__img.setAttribute('src',basePath + 'embed/images/arrow_right.svg');
		...
		this._arrow_right__imgo.setAttribute('src',basePath + 'embed/images/arrow_right__o.svg');
		...
		this._arrow_left__img.setAttribute('src',basePath + 'embed/images/arrow_left.svg');
		...
		this._arrow_left__imgo.setAttribute('src',basePath + 'embed/images/arrow_left__o.svg');
		...
		this._arrow_down__img.setAttribute('src',basePath + 'embed/images/arrow_down.svg');
		...
		this._arrow_down__imgo.setAttribute('src',basePath + 'embed/images/arrow_down__o.svg');
		...
		this._loader1__img.setAttribute('src',basePath + 'embed/images/loader1.svg');
		...
		this._loader2__img.setAttribute('src',basePath + 'embed/images/loader2.svg');
		...
		this._loader3__img.setAttribute('src',basePath + 'embed/images/loader3.svg');
		...
		this._info_window__img.setAttribute('src',basePath + 'embed/images/info_window.png');
		...
		this._svg_2__img.setAttribute('src',basePath + 'embed/images/svg_2.svg');
		...
		this._marker_normal__img.setAttribute('src',basePath + 'embed/images/marker_normal.svg');
		...
		this._marker_active__img.setAttribute('src',basePath + 'embed/images/marker_active.svg');
		...
		this._mapdiv__img.setAttribute('src',basePath + 'embed/images/mapdiv.svg');
		...
		this._mappin_002__img.setAttribute('src',basePath + 'embed/images/mappin_002.svg');
		...
		this._mappin_002__imga.setAttribute('src',basePath + 'embed/images/mappin_002__a.svg');
		...
		this._mappin_003__img.setAttribute('src',basePath + 'embed/images/mappin_003.svg');
		...
		this._mappin_003__imga.setAttribute('src',basePath + 'embed/images/mappin_003__a.svg');
		...
		this._mappin_001__img.setAttribute('src',basePath + 'embed/images/mappin_001.svg');
		...
		this._mappin_001__imga.setAttribute('src',basePath + 'embed/images/mappin_001__a.svg');
		...
		this._mappin_004__img.setAttribute('src',basePath + 'embed/images/mappin_004.svg');
		...
		this._mappin_004__imga.setAttribute('src',basePath + 'embed/images/mappin_004__a.svg');
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='ht_zoom') {
			...
			this._svg_1__img.setAttribute('src',basePath + 'embed/images/svg_1.svg');
		...
		if (hotspot.skinid=='ht_info') {
			...
			this._info_dot__img.setAttribute('src',basePath + 'embed/images/info_dot.svg');
			...
			this._txt_hotspot.ggLeft=-50;
			this._txt_hotspot.ggTop=-40;
			this._txt_hotspot.ggParameter={ rx:0,ry:0,a:0,sx:0,sy:1 };
			...
			this._txt_hotspot.style[domTransform]=parameterToTransform(this._txt_hotspot.ggParameter);
			hs ='position:absolute;';
			hs+='left: 0px;';
			hs+='top:  0px;';
			hs+='width: auto;';
			hs+='height: auto;';
			hs+='background: #3aab47;';
			hs+='border: 0px solid #000000;';
			hs+='color: rgba(255,255,255,1);';
			hs+='text-align: center;';
			hs+='white-space: nowrap;';
			...
			me._txt_hotspot.ggCurrentLogicStateScaling = -1;
			this._txt_hotspot.ggUpdateConditionTimer=function () {
				var newLogicStateScaling;
				if (
					(me.elementMouseOver['_div'] == true)
				)
				...
				if (me._txt_hotspot.ggCurrentLogicStateScaling != newLogicStateScaling) {
					me._txt_hotspot.ggCurrentLogicStateScaling = newLogicStateScaling;
					me._txt_hotspot.style[domTransition]='' + cssPrefix + 'transform 1000ms ease 0ms';
					if (me._txt_hotspot.ggCurrentLogicStateScaling == 0) {
						me._txt_hotspot.ggParameter.sx = 1;
						me._txt_hotspot.ggParameter.sy = 1;
						me._txt_hotspot.style[domTransform]=parameterToTransform(me._txt_hotspot.ggParameter);
					}
					else {
						me._txt_hotspot.ggParameter.sx = 0;
						me._txt_hotspot.ggParameter.sy = 1;
						me._txt_hotspot.style[domTransform]=parameterToTransform(me._txt_hotspot.ggParameter);
					}
				}
			...
			this.hotspotTimerEvent=function() {
				...
				me._txt_hotspot.ggUpdateConditionTimer();
			}
			this.hotspotTimerEvent();
		} else
		if (hotspot.skinid=='ht_url') {
			...
			this._ht_node_image__img.setAttribute('src',basePath + 'embed/images/ht_node_image.svg');
			...
			this._ht_node_image__imgo.setAttribute('src',basePath + 'embed/images/ht_node_image__o.svg');
		...
		} else
		{
			...
			this._deep__img.setAttribute('src',basePath + 'embed/images/deep.svg');
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parent) {
		...
		this._thumbnail_nodeimage__img.setAttribute('src',basePath + "embed/images/thumbnail_nodeimage_" + nodeId + ".jpg");
		...
		this._checkmark_tick__img.setAttribute('src',basePath + 'embed/images/checkmark_tick.svg');
